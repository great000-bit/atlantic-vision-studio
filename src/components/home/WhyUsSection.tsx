...
const iconMap: Record<string, typeof Check> = {
  Check, Shield, Users, Zap, Award, Clock
};
...
export const WhyUsSection = () => {
  ...
  const heading = getContentValue(content, 'heading', 'Atlantic Creators Advantage');
  const subheading = getContentValue(content, 'subheading', "We're your creative partners committed to excellence.");
  const benefits = getContentValue(content, 'benefits', defaultBenefits) as { icon: string; title: string; description: string }[];
    ...
    <section className="section-padding bg-background relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div>
            <SectionHeading label={label} title={heading} subtitle={subheading} align="left" />
