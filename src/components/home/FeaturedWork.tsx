    ...
    <section className="section-padding bg-card relative">
      <div className="container mx-auto px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="A curated selection of our best photography, videography, and documentary work."
        />
              ...
              <Link to={`/portfolio/${project.id}`} className="block">
                <div className={`relative ${index === 0 || index === 3 ? "aspect-[3/4]" : "aspect-video"}`}>
                  ...
                  <div className="absolute bottom-0 left-0 right-0 p-6">
                    ...
                    <h3 className="font-heading text-xl font-semibold text-foreground mt-2 group-hover:text-primary transition-colors">
                      {project.title}
                    </h3>
                  </div>
